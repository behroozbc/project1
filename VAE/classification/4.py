...
# Parallel Convolution Block for Encoder
...
# Parallel Transposed Convolution Block for Decoder (intermediate blocks)
...
# Final Parallel Transposed Convolution Block (outputs 1 channel)
...
class VAE(nn.Module):
    def __init__(self, Z_dim=64):
        ...
        self.encoder = nn.Sequential(
            ParallelConvBlock(1, 32, 4),    # 513x51x1 -> 256x25x16
            ParallelConvBlock(16, 32, 8),   # 256x25x16 -> 127x12x32
            ParallelConvBlock(32, 32, 16),  # 127x12x32 -> 63x5x64
            ParallelConvBlock(64, 32, 32)   # 63x5x64 -> 31x2x128
        )
        ...
        self.decoder_blocks = nn.ModuleList([
            ...
            FinalParallelConvTransposeBlock(16, 32,1, output_padding=(0,0))   # 256x25x16 -> 513x51x1
        ])
