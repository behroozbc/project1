    ...
    def __init__(self):
        ...
        self.conv1 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(8),
                nn.ELU(),
                nn.Conv2d(8, 8, kernel_size=3, padding=1),  # (8, 201, 6) -> (8, 201, 6)
                nn.BatchNorm2d(8),
                nn.ELU(),
        ...
        self.conv2 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(16),
                nn.ELU(),
                nn.Conv2d(16, 16, kernel_size=3, padding=1),  # (16, 100, 3) -> (16, 100, 3)
                nn.BatchNorm2d(16),
                nn.ELU(),
        ...
        self.conv3 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(32),
                nn.ELU(),
                nn.Conv2d(32, 32, kernel_size=3, padding=1),  # (32, 50, 1) -> (32, 50, 1)
                nn.BatchNorm2d(32),
                nn.ELU(),
        ...
        self.conv4 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(64),
                nn.ELU(),
                nn.Conv2d(64, 64, kernel_size=3, padding=1),  # (64, 25, 1) -> (64, 25, 1)
                nn.BatchNorm2d(64),
                nn.ELU(),
    ...
    def __init__(self):
        ...
        self.deconv1 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(32),
                nn.ELU(),
                nn.Conv2d(32, 32, kernel_size=3, padding=1),  # (32, 25, 1) -> (32, 25, 1)
                nn.BatchNorm2d(32),
                nn.ELU()
            ) for _ in range(3)
        ])
        ...
        self.deconv2 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(16),
                nn.ELU(),
                nn.Conv2d(16, 16, kernel_size=3, padding=1),  # (16, 50, 1) -> (16, 50, 1)
                nn.BatchNorm2d(16),
                nn.ELU()
            ) for _ in range(3)
        ])
        ...
        self.deconv3 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(8),
                nn.ELU(),
                nn.Conv2d(8, 8, kernel_size=3, padding=1),  # (8, 100, 3) -> (8, 100, 3)
                nn.BatchNorm2d(8),
                nn.ELU()
            ) for _ in range(3)
        ])
        ...
        self.deconv4 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.BatchNorm2d(1),
                nn.ELU(),
                nn.Conv2d(1, 1, kernel_size=3, padding=1),  # (1, 201, 6) -> (1, 201, 6)
                nn.BatchNorm2d(1),
                nn.ELU()
            ) for _ in range(3)
        ])
...
writer = SummaryWriter(log_dir='./runs/'+nowTime+'paraller-deeeeeper-autoencoder64')
...
torch.save(enc.state_dict(), nowTime)